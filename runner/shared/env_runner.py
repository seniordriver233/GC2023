    ...
    def run(self):
        ...
        for episode in range(episodes):
            ...
            for step in range(self.episode_length):
                ...
                energy_com.append(np.mean(infos))
            ...
            if episode % self.log_interval == 0:
                ...
                train_infos["average_episode_energy"] = (np.mean(energy_com))

                print(
                    "average episode rewards is {} with energy {}".format(
                        train_infos["average_episode_rewards"], train_infos["average_episode_energy"]
                    )
                )
